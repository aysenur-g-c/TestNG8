 ...
 */
    ...
    //Buradaki test parametre beklediğinden sadece xml den çalıştırılabilir
    @Test
    @Parameters ("mesaj") // xml de ki name ile aynı olmalı
    public void Test(String gelenMesaj){ // parametre alacak
